...
tests = [ {'description': 'A=0x04, A=0x00, A=0x06 ==> PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x04 )],'iterations': 1}, 
        {'inputs': [('PINA',0x00)], 'iterations': 1}, 
        {'inputs': [('PINA',0x06)], 'iterations': 1}],
    'expected': [('PORTB',0x00)],
    },
    {'description': 'A=0x67, A=0x04, A=0x00, A=0x02 ==> PORTB: 0x01',
